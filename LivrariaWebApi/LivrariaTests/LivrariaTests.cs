...
{
    public class LivrariaTests
    {
        // private readonly LivrariaBusiness.LivrariaBusiness livrariaBusiness;

        // public LivrariaTests()
        // {
        //     livrariaBusiness = new LivrariaBusiness.LivrariaBusiness();
        // }

        // [Fact]
        // [Trait(nameof(LivrariaBusiness.LivrariaBusiness.Add), "Sucesso")]
